...
const mount = (root) => {
    ...
    // mount. Mirror it into the global so store/composable URL helpers build
    // correct paths; otherwise their hardcoded root fallback 404s on
    // subdirectory installs (`host/studip/…`).
